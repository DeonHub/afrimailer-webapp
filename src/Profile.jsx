  ...
  return (
    <>
      <div className="flex h-screen overflow-scroll bg-white">
        ...
        <div className="flex flex-col flex-1 h-full overflow-scroll">
          <Header />
                ...
                <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                  {/* <div className="relative z-20 h-35 md:h-65">
                    <img
                      ...
                      alt="profile cover"
                      className="h-52 w-52 rounded-full object-cover object-center p-0 m-auto"
                    />
                  ...
                  <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
                    <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
                      <div className="relative drop-shadow-2">
                        <img src="https://afriaminternational.com/wp-content/uploads/2024/06/Mandy.jpg" alt="profile" className="rounded-full" />
                        <label
                          for="profile"
                    ...
                    <div className="mt-4">
                      ...
                      <div className="mx-auto max-w-180">
                        ...
                        <p className="mt-4.5 text-sm font-normal">
                          ...
                          aliquet. Etiam dictum dapibus ultricies. Sed vel
                          aliquet libero. Nunc a augue fermentum, pharetra
